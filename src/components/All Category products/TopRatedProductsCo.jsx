...
function TopRatedProductsCo({ format_topRated_products, product_fetch }) {
    ...
    return (
        <div className=' w-full'>
            <div className=' flex items-center justify-between px-3'>
                <h1 className=' text-[24px] font-[600] tracking-wide flex items-center gap-x-1 font-sans'> Top Rated Products</h1>
            ...
            <div>
                ...
                {/* => kaj comming soon */}
                {
                    product_fetch &&
                    <Carousel
                        autoPlay={format_topRated_products.length > 1 ? true : false}
                        infinite={true}
                        arrows={false}
                        showDots={false}
                        autoPlaySpeed={3000}
                    ...
                    >
                        {
                            format_topRated_products.map((p, i) => {
...
export default TopRatedProductsCo